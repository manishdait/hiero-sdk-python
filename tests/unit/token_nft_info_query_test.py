...
def test_execute_token_nft_info_query(nft_id):
    ...
    nft_info_response = token_get_nft_info_pb2.TokenNftInfo(
        nftID=basic_types_pb2.NftID(
            token_ID=basic_types_pb2.TokenID(shardNum=0, realmNum=0, tokenNum=1), serial_number=2
        ),
        accountID=basic_types_pb2.AccountID(shardNum=0, realmNum=0, accountNum=3),
