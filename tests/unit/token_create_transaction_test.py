...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("1" * 101, "SYMB", 2, 100, TokenType.FUNGIBLE_COMMON, "Token name must be between 1 and 100 bytes"),
        ("\x00", "SYMB", 2, 100, TokenType.FUNGIBLE_COMMON, "Token name must not contain the Unicode NUL"),
        ("MyToken", "", 2, 100, TokenType.FUNGIBLE_COMMON, "Token symbol is required"),
        ("MyToken", "1" * 101, 2, 100, TokenType.FUNGIBLE_COMMON, "Token symbol must be between 1 and 100 bytes"),
        ("MyToken", "\x00", 2, 100, TokenType.FUNGIBLE_COMMON, "Token symbol must not contain the Unicode NUL"),
        ("MyToken", "SYMB", -2, 100, TokenType.FUNGIBLE_COMMON, "Decimals must be a non-negative integer"),
        ("MyToken", "SYMB", 2, -100, TokenType.FUNGIBLE_COMMON, "Initial supply must be a non-negative integer"),
        (
            "MyToken",
            "SYMB",
            2,
        ...
        ("MyToken", "SYMB", 2, 2**64, TokenType.FUNGIBLE_COMMON, "Initial supply cannot exceed"),
        # Valid fungible
        ...
        ("1" * 101, "SYMB", 0, 0, TokenType.NON_FUNGIBLE_UNIQUE, "Token name must be between 1 and 100 bytes"),
        ("\x00", "SYMB", 0, 0, TokenType.NON_FUNGIBLE_UNIQUE, "Token name must not contain the Unicode NUL character"),
        ("MyNFTToken", "", 0, 0, TokenType.NON_FUNGIBLE_UNIQUE, "Token symbol is required"),
        ("MyNFTToken", "1" * 101, 0, 0, TokenType.NON_FUNGIBLE_UNIQUE, "Token symbol must be between 1 and 100 bytes"),
        (
            "MyNFTToken",
            "\x00",
            0,
        ...
        ("MyNFTToken", "SYMB", -2, 0, TokenType.NON_FUNGIBLE_UNIQUE, "Decimals must be a non-negative integer"),
        (
            "MyNFTToken",
            "SYMB",
            2,
...
def test_supply_type_and_max_supply_validation(
    mock_account_ids, token_type, supply_type, max_supply, initial_supply, expected_error
):
    """
