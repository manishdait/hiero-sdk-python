...
def test_token_nft_info_constructor(mock_account_ids, nft_id):
    ...
    token_nft_info = TokenNftInfo(
        nft_id=nft_id, account_id=account_id, creation_time=creation_time, metadata=metadata, spender_id=spender_id
    )
...
def test_from_proto():
    ...
    proto = token_get_nft_info_pb2.TokenNftInfo(
        ...
        metadata=b"test metadata",
        spender_id=basic_types_pb2.AccountID(shardNum=0, realmNum=0, accountNum=101112),
    )
