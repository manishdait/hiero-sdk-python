...
def test_token_nft_transfer_constructor(mock_account_ids):
    ...
    nft_transfer = TokenNftTransfer(
        token_id=token_id, sender_id=sender_id, receiver_id=receiver_id, serial_number=serial_number
    )
    ...
    approved_transfer = TokenNftTransfer(
        token_id=token_id, sender_id=sender_id, receiver_id=receiver_id, serial_number=serial_number, is_approved=True
    )
