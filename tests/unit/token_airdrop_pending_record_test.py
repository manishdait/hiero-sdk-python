...
def test_pending_airdrop_record_constructor(mock_account_ids):
    ...
    token_pending_airdrop_id = PendingAirdropId(sender_id=sender_id, receiver_id=receiver_id, token_id=token_id_1)

    nft_pending_airdrop_id = PendingAirdropId(sender_id=sender_id, receiver_id=receiver_id, nft_id=nft_id)

    # Pending airdrop id with token
    pending_airdrop_record_1 = PendingAirdropRecord(pending_airdrop_id=token_pending_airdrop_id, amount=amount)
    ...
    pending_airdrop_record_2 = PendingAirdropRecord(pending_airdrop_id=nft_pending_airdrop_id, amount=amount)
...
def test_pending_airdrop_record_to_proto_for_fungible_token(mock_account_ids):
    ...
    pending_airdrop_id = PendingAirdropId(sender_id=sender_id, receiver_id=receiver_id, token_id=token_id)

    # Pending airdrop id with token
    record = PendingAirdropRecord(pending_airdrop_id=pending_airdrop_id, amount=amount)
...
def test_pending_airdrop_record_to_proto_for_nft(mock_account_ids):
    ...
    pending_airdrop_id = PendingAirdropId(sender_id=sender_id, receiver_id=receiver_id, nft_id=nft_id)
...
def test_pending_airdrop_record_from_proto_for_fungible_token(mock_account_ids):
    ...
    assert record.pending_airdrop_id.nft_id is None
...
def test_pending_airdrop_record_from_proto_for_nft(mock_account_ids):
    ...
    assert record.pending_airdrop_id.token_id is None
