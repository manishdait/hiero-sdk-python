...
def test_integration_token_wipe_account_transaction_can_execute():
    ...
    try:
        ...
        wipe_transaction = TokenWipeTransaction(token_id=token_id, account_id=account_id, amount=10)

        wipe_transaction.freeze_with(env.client)
        receipt = wipe_transaction.execute(env.client)

        assert receipt.status == ResponseCode.SUCCESS, (
            f"Token wipe failed with status: {ResponseCode(receipt.status).name}"
        )
...
def test_integration_token_wipe_transaction_no_token_id():
    ...
    try:
        ...
        wipe_transaction = TokenWipeTransaction(token_id=None, account_id=account_id, amount=10)
...
def test_integration_token_wipe_transaction_no_account_id():
    ...
    try:
        ...
        wipe_transaction = TokenWipeTransaction(token_id=token_id, account_id=None, amount=10)
...
def test_integration_token_wipe_transaction_no_amount():
    ...
    try:
        ...
        wipe_transaction = TokenWipeTransaction(token_id=token_id, account_id=account_id, amount=0)
