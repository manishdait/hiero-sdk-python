...
class TestHandlerRegistration:
    def test_handler_registration_via_decorator(self):
        ...
        def handler(_params: DummyParams):
            return {"status": "ok"}
    ...
    def test_get_all_handlers(self):
        ...
        @rpc_method("method1")
        def handler1(_params: DummyParams):
            return "result1"

        @rpc_method("method2")
        def handler2(_params: DummyParams):
            return "result2"
    ...
    def test_handler_override(self):
        ...
        @rpc_method("override")
        def first(_params: DummyParams):
            return "first"

        @rpc_method("override")
        def second(_params: DummyParams):
            return "second"
