...
class TopicInfoQuery(Query):
    ...
    def __init__(self, topic_id: TopicId | None = None) -> None:
        """
    ...
    def _get_method(self, channel: _Channel) -> _Method:
        ...
        """
        return _Method(transaction_func=None, query_func=channel.topic.getTopicInfo)
    ...
    def _should_retry(self, response: Any) -> _ExecutionState:
        ...
        retryable_statuses = {ResponseCode.UNKNOWN, ResponseCode.BUSY, ResponseCode.PLATFORM_NOT_ACTIVE}
    ...
    def execute(self, client: Client, timeout: int | float | None = None) -> TopicInfo:
        """
